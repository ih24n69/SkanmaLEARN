					...
					foreach ($allfile as $key => $file) {
						if (is_array($file)) {
							...
							if (is_numeric($key)) {
								...
								if ($filext == 'php') {
									echo "<li><a data-action='".base_url('app/blog_template/get_template_file')."' class='link u-color-primary' href='javascript:;' data-href='".$file['path']."'><i class='fa fa-file'></i> ".$file['name']."</a></li>";
								}
							}else {							
