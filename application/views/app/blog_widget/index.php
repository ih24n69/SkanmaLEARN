				...
				<div class="c-stage u-mb-zero" id="accordion">
					...
					<?php if ($widget): foreach ($widget as $data): ?>
						...
						<div data-parent="#accordion" class="c-stage__panel u-p-medium collapse" id="stage-<?php echo $data['var'] ?>">
							...
							<button data-title="apakah Anda yakin ?" data-text="ingin menghapus <?php echo $data['name'] ?> widget" class="c-btn--custom c-btn--small c-btn c-btn--danger single-action" data-href="<?php echo base_url('app/blog_widget/delete/'.$data['id']) ?>" type="button"><i class="fa fa-trash"></i></button>
