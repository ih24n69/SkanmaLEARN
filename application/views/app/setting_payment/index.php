				...
				<div class="c-card__body u-p-zero u-pt-small">   
					...
					<div class="row">
						<div class="col-12">
							...
							<!-- start transaksi -->
							<div class="c-stage u-m-zero u-border-bottom-zero type-manual" style='<?php echo (isset($site['payment_method']) && $site['payment_method'] == 'Manual') ? '' : 'display:none'; ?>'>
											...
											<tbody>
												<?php if (!empty($payment['transaction'])): ?>
													<?php foreach ($payment['transaction'] as $transaction): ?>
														<tr class="c-table__row">
															<th class="c-table__cell"><?php echo $transaction['type'] ?></th>
															<th class="c-table__cell"><?php echo $transaction['account_number'] ?></th> 
															<th class="c-table__cell"><?php echo $transaction['receiver'] ?></th>
												...
												<?php else: ?>
													<tr class="c-table__row">
														<th class="c-table__cell u-text-center" colspan="4">Tidak ada data!</th>
													</tr>
												<?php endif ?>
											</tbody>
										</table>
							...
							<!-- start konfirmasi -->
							<div class="c-stage u-m-zero u-border-top-zero type-manual" style='<?php echo (isset($site['payment_method']) && $site['payment_method'] == 'Manual') ? '' : 'display:none'; ?>'>
											...
											<tbody>
												<?php if (!empty($payment['confirmation'])): ?>
													<?php foreach ($payment['confirmation'] as $confirmation): ?>
														<tr class="c-table__row">
															<th class="c-table__cell"><?php echo $confirmation['type'] ?></th>
															<th class="c-table__cell"><?php echo $confirmation['data'] ?></th> 
															<th class="c-table__cell" style="width: 10%">
												...
												<?php else: ?>
													<tr class="c-table__row">
														<th class="c-table__cell u-text-center" colspan="3">Tidak ada data!</th>
													</tr>
												<?php endif ?>
											</tbody>
										</table>
