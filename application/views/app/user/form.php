            ...
            <div class="c-card c-card--responsive u-p-zero">
                ...
                <div class="c-card__body">   
					...
					<div class="c-field u-mb-small">
                        <label class="c-field__label">Nama Lengkap</label>
                        <input required="" name="namalengkap" class="c-input" type="text" value="<?php echo (!empty($user['namalengkap'])) ? (!empty(set_value('namalengkap')) ? set_value('namalengkap') : $user['namalengkap'] ) : set_value('namalengkap') ?>"/>
                    ...
                    <div class="c-field u-mb-small">
                        <label class="c-field__label">No.Handphone</label>
                    ...
                    <div class="u-mb-small">
                        <label class="c-field__label">Kata Sandi Baru</label>
                    ...
                    <?php if ($this->session->userdata('app_grade') != 'Instructor'): ?>
                        <?php if (empty($user) OR !empty($user) AND $user['grade'] != 'App'): ?>
                            ...
                            <div class="c-field u-mb-small">
                                <label class="c-field__label">Tingkat : </label>
                                <select required="" name="grade" class="c-select select2" data-placeholder='select'>
                                    <option value=""></option>
                                    <option <?php echo (!empty($user['grade']) AND $user['grade'] == 'User') ? 'selected' : ''; ?> value="User">Pengguna</option>
                                    <option <?php echo (!empty($user['grade']) AND $user['grade'] == 'Instructor') ? 'selected' : ''; ?> value="Instructor">Instruktur</option>
                                </select>
                            </div>
                            ...
                            <div class="c-toggle u-mb-small">
                                <div class="c-toggle__btn <?php echo (!empty($user['status'])) ? ($user['status'] == 'Active') ? 'is-active' : '' : 'is-active'?>">
                                    <label class="c-toggle__label" for="Active">
                                        <input value="Active" class="c-toggle__input" id="Active" name="status" type="radio" <?php echo (!empty($user['status'])) ? ($user['status'] == 'Active') ? 'checked' : '' : 'checked'?>>Aktif
                                    </label>
                                </div>

                                <div class="c-toggle__btn <?php echo (!empty($user['status'])) ? ($user['status'] == 'Blocked') ? 'is-active' : '' : ''?>">
                                    <label class="c-toggle__label" for="Blocked">
                                        <input value="Blocked" class="c-toggle__input" id="Blocked" name="status" type="radio" <?php echo (!empty($user['status'])) ? ($user['status'] == 'Blocked') ? 'checked' : '' : '' ?>>Blok
                                    </label>
                                </div>
                            </div>
                        <?php endif ?>
